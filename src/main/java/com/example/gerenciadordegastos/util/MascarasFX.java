        ...
        datePicker.getEditor().setOnKeyTyped((KeyEvent event) -> {
            ...
            if (event.getCharacter().trim().length() == 0) { // apagando
                ...
                if (datePicker.getEditor().getText().length() != 2 && datePicker.getEditor().getText().length() != 5) {
                    if ("/".equals(String.valueOf(datePicker.getEditor().getText().charAt(datePicker.getEditor().getText().length() - 1)))) {
                ...
                if (datePicker.getEditor().getText().length() > 10) {
                    datePicker.getEditor().setText(datePicker.getEditor().getText().substring(0, 10));
                    datePicker.getEditor().positionCaret(datePicker.getEditor().getText().length());
                }
